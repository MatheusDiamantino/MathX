...
<body>
    ...
    <form action="{{route('generateExercises')}}" method="post">
        @csrf
        <div class="container p-5 border border-primary rounded-3">
        ...
        <div class="container">
            <div class="row">
                <div class="mt-3 text-center alert alert-danger">
                    Por favor selecione pelo menos uma operação. As parcelas devem ser npumeros entre 0 e 999. O número de exercicios deve variar entre 5 e 50.
                </div>
            </div>
        </div>
    @endif
